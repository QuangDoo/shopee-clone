        ...
        <div className='sticky bottom-0 z-10 grid grid-cols-12 items-center rounded-sm bg-white p-5 shadow'>
          <div className='col-span-12 md:col-span-6'>
            <div className='flex flex-shrink-0 items-center pr-3'>
              ...
              <button className='mx-3 border-none bg-none hover:text-primary10'>Xóa</button>
            </div>
          </div>
          <div className='col-span-12 items-center justify-center lg:col-span-6 lg:ml-auto lg:flex'>
            <div>
              <div className='flex items-center justify-center text-sm lg:justify-end'>
                ...
                <div className='ml-2 text-sm text-primary10 lg:text-2xl '>138000</div>
              </div>
              <div className='flex items-center justify-center text-sm lg:justify-end'>
                <div className='text-gray-500'>Tiết kiệm</div>
                <div className='ml-6 text-primary10'>138000</div>
              </div>
            </div>
            <div className='flex items-center justify-center text-sm lg:justify-end'>
              <Button className='rouned ml-2 flex h-10 w-52 items-center justify-center rounded-sm bg-red-500 text-sm uppercase text-white hover:bg-red-600'>
                Mua hàng
              </Button>
            </div>
          </div>
