  ...
  return (
    <div className='rounded-sm bg-white px-2 pb-10 shadow md:px-7 md:pb-20'>
      <Helmet>
        ...
        <meta name='description' content='Thay đổi mật khẩu | Shopee Clone' />
      </Helmet>
        ...
        <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <Input
                inputClassName='w-full rounded-sm border border-gray-300 px-3 py-2 outline-none focus:border-gray-500 focus:shadow-sm'
          ...
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <Button
                className='flex h-9 items-center rounded-sm bg-primary10 px-5 text-center text-sm text-white hover:bg-primary10/80'
                type='submit'
              >
                Lưu
              </Button>
