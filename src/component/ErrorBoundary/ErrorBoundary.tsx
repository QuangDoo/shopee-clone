...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      ...
      return (
        <a href='/' className='flex h-screen w-full flex-col items-center justify-center'>
          ...
          <button className='mt-5'>
            <div className='group relative inline-block text-sm font-medium text-white focus:outline-none focus:ring active:text-orange-500'>
